...
<!-- Header -->
  <div class="fixed w-full flex items-center justify-between h-14 text-white z-10">
        <div class="flex items-center justify-start md:justify-center pl-3 w-14 md:w-64 h-14 bg-yellow-400 dark:bg-yellow-500 border-none">
          <img class="w-7 h-7 md:w-10 md:h-10 mr-2 rounded-md overflow-hidden" src="./gummy3.png" />
      ...
      <div class="fixed flex flex-col top-14 left-0 w-14 hover:w-64 md:w-64 bg-yellow-300 h-full text-white transition-all duration-300 border-none z-10 sidebar">
        <div class="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
          <ul class="flex flex-col py-4 space-y-1">
            ...
            <li>
              <a href="dashboard-kasir.php" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-yellow-800 text-black hover:text-black border-l-4 border-transparent hover:border-black pr-6">
