        ...
        <div class="mt-4 mx-4">
          ...
          <div class="w-full overflow-hidden rounded-lg shadow-xs">
                  ...
                  ?>
                      <tr class="hover:bg-yellow-700">
                        <td class="px-4 py-3">
                          ...
                          <div>
                            <p class="font-semibold text-gray-50"></p>
                          </div>
            </div>
            </td>
            <td class="px-4 py-3 text-sm text-gray-50"></td>
            <td class="px-4 py-3 text-sm text-gray-50"></td>
            ...
            <td class="px-4 py-3 text-sm flex sm:flex-row flex-col">
              <a href="detil-transaksi.php?id=<?= $data['t_id'] ?>" class="px-4 py-2 text-xs rounded-full text-white bg-blue-600 hover:bg-blue-700"><i class="bi bi-info-circle"></i> Detail</a>
              <!-- <a href="../utils/kasir/proses-delete-transaksi.php?id=<?= $data['id'] ?>" class="px-4 py-2 text-xs rounded-full text-white bg-red-600 hover:bg-red-700"><i class="bi bi-trash"></i> Delete</a> -->
            </td>
            </tr>
          <?php else : ?>
            <tr class="hover:bg-yellow-700">
