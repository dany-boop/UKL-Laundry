    ...
    if($_POST){
        ...
        if(empty($status) || empty($payment)){
            ...
            if($update_transaction){
                echo "<script>alert('Ubah Data Transaksi Sukses!');location.href='../../kasir/dashboard-kasir.php';</script>";
            } else {
                echo "<script>alert('Ubah Data Transaksi Gagal! silakan coba kembali!');location.href='../../kasir/detil-transaksi.php';</script>";
            }
        }
    }
?>