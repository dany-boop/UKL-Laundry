...
if($_POST){
    ...
    if(empty($nama)){
        ...
        if($insert){
            echo "<script>alert('Sukses menambahkan member');location.href='../../kasir/tambah-member.php';</script>";
        } else {
            echo "<script>alert('Gagal menambahkan member');location.href='../../kasir/tambah-member.php';</script>";
        }
    }
}
?>
