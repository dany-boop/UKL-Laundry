            ...
            <div class="mt-4 mx-4">
                ...
                <div class="w-full overflow-x-auto">
                    ...
                    <tbody class="bg-yellow-600 divide-y dark:divide-yellow-100">
                        ...
                        <td class="px-4 py-3 text-xs px-2 py-1 font-semibold leading-tight text-white"><?=$data['jenis_kelamin'] ?>
                        </td>
                        <td class="px-4 py-3 text-sm text-gray-50"><?=$data['tlp'] ?></td>
                        <td class="px-4 py-3 text-sm flex sm:flex-row flex-col">
                            <a href="edit-member.php?nama=<?=$data['nama'] ?>" class="px-4 py-2 text-xs rounded-full text-white bg-green-600 hover:bg-green-700"><i class="bi bi-pencil-square"></i> Ubah</a>
                            |
                            <a href="../utils/proses-delete-member.php?nama=<?=$data['nama'] ?>" class="px-4 py-2 text-xs rounded-full text-white bg-red-600 hover:bg-red-700" onclick="return confirm('Apakah anda yakin menghapus data ini?')"><i class="bi bi-trash"></i> Delete</a>
                        </td>
                        </tr>
                        <?php } ?>
                    </tbody>
